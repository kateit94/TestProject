...
jQuery( function( $ ) {
     ...
     * Sortable images
     */
    $('ul.property_gallery_mtb').sortable({
        items:'li',
        ...
        */
        stop:function(event,ui){
            ...
            var sort = new Array(), /* array of image IDs */
                gallery = $(this); /* ul.property_gallery_mtb */
     ...
     */
    $('.property_upload_gallery_button').click( function(e){ /* on button click*/
        e.preventDefault();
            ...
            custom_uploader = wp.media({
                ...
                for (i = 0; i < attachments.length; ++i) {
                    ...
                    if( !in_array( attachments[i].id, hiddenfieldvalue ) ) {
                        ...
                        $('ul.property_gallery_mtb').append('<li data-id="' + attachments[i].id + '"><span style="background-image:url(' + attachments[i].attributes.url + ')"></span><a href="#" class="property_gallery_remove">&times;</a></li>');
                ...
                /* refresh sortable */
                $( "ul.property_gallery_mtb" ).sortable( "refresh" );
     ...
     */
    $('body').on('click', '.property_gallery_remove', function(){
     ...
     * Selected item
     */
    $('body').on('mousedown', 'ul.property_gallery_mtb li', function(){
        var el = $(this);
        el.parent().find('li').removeClass('property-active');
