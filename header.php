...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$hotel_property_description = get_bloginfo( 'description', 'display' );
			if ( $hotel_property_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $hotel_property_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
